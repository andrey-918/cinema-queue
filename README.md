...
Предварительное бронирование места

![2](./2.png)

Другие пользователи не могут выбрать место, которое вы выбрали
...
После успешного бронирования место становится окончательно недоступным другим пользователям
